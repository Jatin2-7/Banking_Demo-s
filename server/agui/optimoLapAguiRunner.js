...
const log = module_('optimo-lap-agui');
...
function buildSystemPrompt(state) {
  ...
  return `${OPTIMO_LAP_AGENT_SYSTEM}\n\n## Current form state\n${JSON.stringify(state, null, 2)}\n\n## Validation\n${JSON.stringify(validation)}`;
}

export async function streamOptimoLapAguiRun(res, agentId, inputData, { signal } = {}) {
  if (agentId !== OPTIMO_LAP_AGENT_ID) {
