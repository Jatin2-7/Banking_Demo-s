...
export const TRANSACTIONS = [
  {
    ...
    type: 'DR',
    amount: 1800,
    description: 'UPI/BESCOM ELECTRICITY/bescom@icici/Online Bill Payment',
    mode: 'UPI',
    balance: 251000,
  },
  {
    ...
    type: 'DR',
    amount: 499,
    description: 'UPI/AIRTEL POSTPAID/airtel@axis/Mobile Recharge May 2026',
    mode: 'UPI',
    balance: 252800,
  },
  {
    ...
    type: 'DR',
    amount: 3250,
    description: 'UPI/SWIGGY INSTAMART/swiggy@hdfc/Grocery Order #GR82941',
    mode: 'UPI',
    balance: 253299,
  },
  {
    ...
    type: 'DR',
    amount: 12000,
    description: 'IMPS/TRF TO RAHUL SHARMA/HDFC BANK/A/C XXXXXXXH124/Ref 812934501',
    mode: 'IMPS',
    balance: 256549,
  },
  {
    ...
    type: 'DR',
    amount: 750,
    description: 'UPI/ZOMATO/zomato@paytm/Food Order #ZO99234',
    mode: 'UPI',
    balance: 268549,
  },
  {
    ...
    type: 'DR',
    amount: 1100,
    description: 'UPI/INDANE GAS/indane@okicici/LPG Cylinder Booking',
    mode: 'UPI',
    balance: 269299,
  },
  {
    ...
    type: 'DR',
    amount: 45000,
    description: 'EMI/HDFC BANK CARLOAN/EMI May 2026/Loan A/C 91028374',
    mode: 'NACH',
    balance: 270399,
  },
  {
    ...
    type: 'CR',
    amount: 125000,
    description: 'CREDIT/SALARY MAY 2026/TECHINFRA SOLUTIONS PVT LTD/NEFT/Ref 71823400',
    mode: 'NEFT',
    balance: 315399,
  },
  {
    ...
    type: 'DR',
    amount: 2200,
    description: 'UPI/AMAZON PAY/amazon@apl/Purchase Order #404-8912345-6712340',
    mode: 'UPI',
    balance: 190399,
  },
  {
    ...
    type: 'DR',
    amount: 999,
    description: 'UPI/AIRTEL BROADBAND/airtel.bb@axis/Broadband Apr 2026',
    mode: 'UPI',
    balance: 192599,
  },
  {
    ...
    type: 'DR',
    amount: 580,
    description: 'UPI/BWSSB WATER/bwssb@upi/Water Bill Apr 2026',
    mode: 'UPI',
    balance: 193598,
  },
  {
    ...
    type: 'DR',
    amount: 3500,
    description: 'UPI/PRIYA NAIR/priya.nair@okicici/Rent Share Apr',
    mode: 'UPI',
    balance: 194178,
  },
  {
    ...
    type: 'DR',
    amount: 12500,
    description: 'UPI/LIC OF INDIA/lic@upi/Policy Prem 987654321/Apr 2026',
    mode: 'UPI',
    balance: 197678,
  },
  {
    ...
    type: 'DR',
    amount: 850,
    description: 'ATM WDL/IB ATM BHOPAL MAIN BRANCH/Card XXXX1762',
    mode: 'ATM',
    balance: 210178,
  },
  {
    ...
    type: 'DR',
    amount: 1450,
    description: 'UPI/SWIGGY/swiggy@hdfc/Dining Apr 2026',
    mode: 'UPI',
    balance: 211028,
  },
  {
    ...
    type: 'DR',
    amount: 2100,
    description: 'NEFT/TRF TO VIKRAM SINGH/AXIS BANK/Ref 60912837/Personal',
    mode: 'NEFT',
    balance: 212478,
  },
  {
    ...
    type: 'DR',
    amount: 45000,
    description: 'EMI/HDFC BANK CARLOAN/EMI Apr 2026/Loan A/C 91028374',
    mode: 'NACH',
    balance: 214578,
  },
  {
    ...
    type: 'CR',
    amount: 125000,
    description: 'CREDIT/SALARY APR 2026/TECHINFRA SOLUTIONS PVT LTD/NEFT/Ref 68710200',
    mode: 'NEFT',
    balance: 259578,
  },
  {
    ...
    type: 'DR',
    amount: 4999,
    description: 'UPI/MYNTRA/myntra@ybl/Online Shopping Order #MYN2348901',
    mode: 'UPI',
    balance: 134578,
  },
  {
    ...
    type: 'DR',
    amount: 1800,
    description: 'UPI/BESCOM ELECTRICITY/bescom@icici/Online Bill Payment Mar',
    mode: 'UPI',
    balance: 139577,
  },
];
