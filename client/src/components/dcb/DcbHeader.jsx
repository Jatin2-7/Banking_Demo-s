...
/** Light-blue app header used across DCB screens */
...
export function DcbHomeHeader({ onMenu, onSearch, onLogout }) {
  return (
    <header className="shrink-0 bg-[#B3D4FC] px-3 pb-2.5 pt-1">
      <div className="flex items-center gap-2">
        <button
          type="button"
          onClick={onMenu}
          className="flex h-9 w-9 shrink-0 items-center justify-center text-[#1A237E] press"
          aria-label="Menu"
        >
        ...
        <div className="flex min-w-0 flex-1 justify-center">
          <span className="inline-block rounded-lg bg-[#1A237E] px-5 py-1.5 text-[13px] font-bold tracking-wide text-white shadow-sm">
            DCB BANK
          </span>
        </div>

        <div className="flex shrink-0 items-center gap-0.5 text-[#1A237E]">
          <button
            type="button"
            onClick={onSearch}
