...
function StatusBar() {
  return (
    <div className="absolute top-0 left-0 right-0 h-11 px-7 flex items-center justify-between text-[13px] font-semibold text-ink z-30 pointer-events-none">
      <span>9:41</span>
      <div className="flex items-center gap-1">
        <svg width="16" height="10" viewBox="0 0 16 10" fill="none">
          <rect x="0" y="6" width="3" height="4" rx="0.5" fill="#1A1A2E" />
          <rect x="4" y="4" width="3" height="6" rx="0.5" fill="#1A1A2E" />
          <rect x="8" y="2" width="3" height="8" rx="0.5" fill="#1A1A2E" />
          <rect x="12" y="0" width="3" height="10" rx="0.5" fill="#1A1A2E" />
        </svg>
        ...
        <div className="ml-1 flex items-center">
          <div className="relative w-6 h-3 rounded-[3px] border border-ink/80">
            <div className="absolute inset-[2px] right-[6px] bg-ink rounded-[1px]" />
          </div>
          <div className="w-[2px] h-1.5 bg-ink/80 rounded-r ml-[1px]" />
        </div>
      </div>
    </div>
  );
