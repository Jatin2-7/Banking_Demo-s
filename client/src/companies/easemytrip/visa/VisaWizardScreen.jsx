...
function StepIndicator({ currentStep }) {
  ...
  return (
    <div className="border-b border-emt-borderLight bg-white px-3 py-4">
      ...
      <p className="mb-3 text-[11px] font-medium text-emt-muted">
  ...
  return (
    <div className="mx-4 mt-4 rounded-2xl border border-emt-border bg-white p-4 shadow-sm">
      ...
      >
        ...
        <div>
          ...
          <p className="text-[11px] font-bold">
            {form.departureDateLabel || '30 Jul 2026, 06:33 PM'}
          </p>
        </div>
      </div>
      <p className="text-right text-[10px] font-medium text-red-500">
        {form.travellers}/ Adult Added
      </p>
      ...
      >
        {form.photoUploaded ? (
          <>
            <div className="flex h-20 w-20 items-center justify-center rounded-full bg-emt-blue/10 text-3xl">
              👤
            </div>
  ...
  return (
    <div className="mx-4 mt-4 rounded-2xl border border-emt-border bg-white p-4 shadow-sm">
      ...
      <p className="mt-1 text-[11px] text-emt-muted">
        Position your passport within the frame for automatic scanning.
      </p>
      <button
        type="button"
    ...
    <div className="mx-4 mt-4 rounded-2xl border border-emt-border bg-white p-4 shadow-sm">
      <div className="flex items-center gap-2 rounded-lg bg-green-50 p-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-emt-muted">{form.departureDateLabel || `15 Jul 2026`}</p>
        </div>
      </div>
  ...
  const toolHandler = React.useCallback(
    (name, args) => {
      if (name === 'set_field' || name === 'select_option') {
        ...
        let val = args.value;
        if (key === 'photoUploaded' || key === 'passportScanned')
